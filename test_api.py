...
def get_input_data(test_positive_sentiment: bool) -> Dict[str, str]:
    ...
    Args:
        test_positive_sentiment (bool): Flag to determine the type
        of sentiment to test.
...
def main() -> None:
    ...
    Determines the type of sentiment to test, sends the input data
    to the prediction endpoint, and asserts the response matches
    the expected sentiment.

    Raises:
        AssertionError: If the response does not match
        the expected sentiment.
    """
